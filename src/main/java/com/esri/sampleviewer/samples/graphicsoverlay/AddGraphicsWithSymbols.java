...
/**
 * This sample shows how to add graphics to a graphics overlay which are
 * rendered using a unique value renderer. The unique value renderer uses
 * attributes on the graphic to control the symbol which is used to display your
 * graphics. <br>
 * <br>
 * This application shows the locations of sea birds which are rendered
 * according to the value of the SEABIRD attribute in each graphic.
 */
...
public class AddGraphicsWithSymbols extends Application {
  ...
  public void start(Stage stage) throws Exception {
    ...
    try {
      ...
      addNestingGround(graphicsOvelay);
  ...
  private void addBuoyPoints(GraphicsOverlay graphicsOverlay) {
    ...
    SimpleMarkerSymbol boueyMarker = new SimpleMarkerSymbol(new RgbColor(255,
  ...
  private void addText(GraphicsOverlay graphicsOverlay) {
    ...
    // create text symbols
    TextSymbol bassRockSymbol = new TextSymbol(10, "Bass Rock", new RgbColor(0,
        0, 230, 255), HorizontalAlignment.LEFT, VerticalAlignment.BOTTOM);
    TextSymbol craigleithSymbol = new TextSymbol(10, "Craigleith",
        new RgbColor(0, 0, 230, 255), HorizontalAlignment.RIGHT,
        VerticalAlignment.TOP);

    // define a graphic from the geometry and symbol
    Graphic bassRockGraphic = new Graphic(bassLocation, bassRockSymbol);
    Graphic craigleithGraphic = new Graphic(craigleithLocation,
        craigleithSymbol);
  ...
  private void addNestingGround(GraphicsOverlay graphicsOverlay) {
    ...
    SimpleLineSymbol outlineSymbol = new SimpleLineSymbol(
        SimpleLineSymbol.Style.DASH, new RgbColor(0, 0, 128, 255), 1, 1.0f);
    SimpleFillSymbol fillSymbol = new SimpleFillSymbol(new RgbColor(0, 80, 0,
        255), SimpleFillSymbol.Style.DIAGONAL_CROSS, outlineSymbol, 1.0f);
  ...
  private Polyline getBoatTripGeometry() {
    ...
    Polyline boatRoute = new Polyline(boatPositions);
  ...
  private Polygon getNestingGroundGeometry() {
    ...
    Polygon nestingGround = new Polygon(points);

    return nestingGround;
  }
}
