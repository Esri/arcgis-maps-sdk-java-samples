...
ArcGIS tiled layers do not support reprojection, query, select, identify, or editing. See the [Layer types](https://developers.arcgis.com/java/layers/#layer-types) discussion in the *ArcGIS Developers* Java guide to learn more about the characteristics of ArcGIS tiled layers.
