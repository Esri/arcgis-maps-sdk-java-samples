...
public class EditFeaturesWithFeatureLinkedAnnotationSample extends Application {
  ...
  private static EditFeaturesWithFeatureLinkedAnnotationController controller;

  @Override
  public void start(Stage stage) throws IOException {

    // set up the scene
    FXMLLoader loader = new FXMLLoader(getClass().getResource("/edit_features_with_feature_linked_annotation/main.fxml"));
