...
public class LocalServerGeoprocessingController {
  ...
  public void initialize() {
    ...
    try {
      ...
      //
      String rasterURL = Paths.get(getClass().getResource("/RasterHillshade.tpk").toURI()).toString();
      ...
      server.addStatusChangedListener(status -> {
        if (status.getNewStatus() == LocalServerStatus.STARTED) {
          try {
            String gpServiceURL = Paths.get(getClass().getResource("/Contour.gpk").toURI()).toString();
